            ...
            <form action="tambah_kendaraan_masuk.php" class="pure-form pure-form-stacked" method="post">
                <div class="input-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="text" class="pure-input-1" id="no_plat" name="no_plat" placeholder="Masukkan Nomor Plat Kendaraan" required autofocus>
                    </div>
                </div>
                <div class="input-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="text" id="pengemudi" name="pengemudi" class="pure-input-1" placeholder="Masukkan Nama Pengemudi" >
                    </div>
                </div>
                <div class="input-group">
