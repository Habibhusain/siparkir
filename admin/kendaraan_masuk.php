                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($row['waktu_keluar'] == '0000-00-00 00:00:00' || empty($row['waktu_keluar'])): ?>
                                    <a href="tambah_kendaraan_keluar.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa-solid fa-arrow-right-from-bracket"></i> Keluar</a>
                                <?php else: ?>
                                    <span class="btn-secondary ">Sudah Keluar</span>
                                <?php endif; ?>
                            </td>
                            <td class="button">
